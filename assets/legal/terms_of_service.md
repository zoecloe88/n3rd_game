...
By downloading, installing, or using N3RD Trivia ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

## 2. Description of Service

N3RD Trivia is a mobile trivia game application that provides:
- Multiple game modes and difficulty levels
- Trivia questions across various categories
- User accounts and progress tracking
- Subscription-based premium features
- Online features including multiplayer and daily challenges
...
- Regular trivia database
- Limited to 5 games per day
...
**Premium Tier:**
- Access to all game modes including AI Mode
- Access to all editions (Regular and Youth)
- Full online features (multiplayer, daily challenges, leaderboards)
- Unlimited gameplay

### Payment and Billing
- Subscriptions are billed monthly or annually
- Payments are processed through RevenueCat and your device's app store
...
- The App, including all code, graphics, and design, is protected by copyright
- Our trademarks and logos are our property

### Your Rights
- You retain ownership of content you create (e.g., user-generated content)
...
- Otherwise harm the App or other users
...
### Informal Resolution
- Contact us at support@n3rdtrivia.app to resolve disputes
...
By using N3RD Trivia, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
