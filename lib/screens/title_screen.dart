...
class _TitleScreenState extends State<TitleScreen> {
  Widget _buildMenuButton(
    ...
    final horizontalPadding = ResponsiveHelper.responsiveWidth(context, 0.08)
        .clamp(16.0, 48.0);

    // Responsive button height: 7% of screen height, min 48px, max 64px
    final buttonHeight = ResponsiveHelper.responsiveHeight(context, 0.07)
        .clamp(48.0, 64.0);
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Semantics(
                      label: AppLocalizations.of(context)?.menuButton ?? 'Menu',
                      button: true,
                      child: IconButton(
                        icon: Icon(Icons.menu, color: colors.onDarkText),
                        onPressed: () => _showMenuDrawer(context),
                        tooltip:
                            AppLocalizations.of(context)?.menuButton ?? 'Menu',
                      ),
                    ),
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    ...
                    final horizontalPadding = ResponsiveHelper
                        ...
                        .clamp(8.0, 24.0);
                    final verticalPadding = ResponsiveHelper
                        .responsiveHeight(context, 0.025)
                        .clamp(12.0, 24.0);
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Builder(
                            builder: (context) {
                              final screenWidth = ResponsiveHelper
                                  .responsiveWidth(context, 1.0);
                              // Responsive title font size: 11% of screen width, min 28px, max 56px
                              final titleFontSize = ResponsiveHelper
                                  .responsiveFontSize(
                                context,
                              ...
                              // Responsive spacing
                              final titleSpacing = ResponsiveHelper
                          ...
                          Builder(
                            builder: (context) {
                              ...
                              final subtitleFontSize = ResponsiveHelper
                                  .responsiveFontSize(
                                context,
                              ...
                              final sectionSpacing = ResponsiveHelper
                          ...
                          Builder(
                            builder: (context) {
                              final buttonSpacing = ResponsiveHelper
                                  .responsiveHeight(context, 0.015)
                                  .clamp(8.0, 16.0);
                          ...
                          _buildMenuButton(
                            ...
                            label: 'Leaderboard',
                            onPressed: () => _switchToLeaderboardTab(context),
                            isPrimary: false,
                          ),
