...
void main() {
  ...
  testWidgets('ResponsiveHelper detects tablets correctly', (tester) async {
          ...
          child: Builder(
            builder: (context) {
              ...
              expect(
                ...
                false,
                reason:
                    '375x667 should be detected as phone (shortestSide=375 < 600)',
              );
          ...
          child: Builder(
            builder: (context) {
              ...
              expect(
                ...
                true,
                reason:
                    '768x1024 should be detected as tablet (shortestSide=768 >= 600)',
              );
              return const SizedBox();
            },
          ),
  ...
  testWidgets('ResponsiveHelper calculates responsive sizes', (tester) async {
    await tester.binding.setSurfaceSize(const Size(375, 667));
    addTearDown(() => tester.binding.setSurfaceSize(null));
  ...
  testWidgets('ResponsiveHelper calculates Lottie heights', (tester) async {
    // Phone
    await tester.binding.setSurfaceSize(const Size(375, 667));
    addTearDown(() => tester.binding.setSurfaceSize(null));
        ...
        home: MediaQuery(
          ...
          child: Builder(
            builder: (context) {
              ...
              ); // Should be reasonable (66.7)
              // Allow for rounding - actual value should be around 66.7
              expect(
                phoneHeight,
                closeTo(66.7, 5.0),
              ); // More tolerance for floating point
              return const SizedBox();
            },
          ),
        ),
