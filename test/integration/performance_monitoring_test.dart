...
void main() {
  ...
  group('Performance Monitoring Tests', () {
    ...
    test('AnalyticsService tracks template initialization performance',
        () async {
      ...
      // Note: Templates library may not be loaded, so we check safely
  ...
  group('Network Performance Monitoring', () {
    ...
    test('NetworkService caches reachability results for performance',
        () async {
      final networkService = NetworkService();
      await networkService.init();
  ...
  group('Template Initialization Performance', () {
    test('Template initialization tracks duration', () async {
      // Load templates library first
      await templates.loadLibrary();
    ...
    test('Template initialization tracks retry attempts', () async {
      // Load templates library first
      await templates.loadLibrary();
