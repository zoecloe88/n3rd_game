...
void main() {
  ...
  group('Accessibility Service Tests', () {
    ...
    testWidgets('AccessibilityService provides font scaling support',
        (tester) async {
    ...
    testWidgets('Typography supports high contrast mode', (tester) async {
  ...
  group('Font Scaling', () {
    testWidgets('Typography scales with system font size', (tester) async {
    ...
    testWidgets('All text styles support custom font sizes', (tester) async {
